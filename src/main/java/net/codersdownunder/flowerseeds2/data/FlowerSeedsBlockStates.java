...
public abstract class FlowerSeedsBlockStates extends BlockStateProvider {
    ...
    private final String MODID = FlowerSeeds2.MODID;
    ...
    private BlockModelBuilder stage(String texture, Integer stage, String flower) {
        ...
        return models().getBuilder("dandelion_seed_stage" + stage)
                .texture("particle", mcLoc(texture))
                .customLoader(CompositeModelBuilder::begin)
                .child("flower0", models().singleTexture(flower + "0_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", mcLoc(texture))
                        .rootTransforms().translation(0.23f, vertical_offset, 0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .child("flower1", models().singleTexture(flower + "1_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", mcLoc(texture))
                        .rootTransforms().translation(-0.23f, vertical_offset, 0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .child("flower2", models().singleTexture(flower + "2_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", mcLoc(texture))
                        .rootTransforms().translation(-0.23f, vertical_offset, -0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .child("flower3", models().singleTexture(flower + "3_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", mcLoc(texture))
                        .rootTransforms().translation(0.23f, vertical_offset, -0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .end();
    }
    ...
    public BlockModelBuilder fullyGrownCompat(ResourceLocation texture, String model, String flower, String modid) {
        ...
        return models().getBuilder(flower + "_seed_stage3")
                ...
                .customLoader(CompositeModelBuilder::begin)
                .child("flower0", models().withExistingParent(flower + "0_stage3", ResourceLocation.parse(modid + ":" + model))
                        .rootTransforms().translation(0.23f, vertical_offset, 0.23f).end().renderType("minecraft:cutout_mipped"))
                .child("flower1", models().withExistingParent(flower + "1_stage3", ResourceLocation.parse(modid + ":" + model))
                        .rootTransforms().translation(-0.23f, vertical_offset, 0.23f).end().renderType("minecraft:cutout_mipped"))
                .child("flower2", models().withExistingParent(flower + "2_stage3", ResourceLocation.parse(modid + ":" + model))
                        .rootTransforms().translation(-0.23f, vertical_offset, -0.23f).end().renderType("minecraft:cutout_mipped"))
                .child("flower3", models().withExistingParent(flower + "3_stage3", ResourceLocation.parse(modid + ":" + model))
                        .rootTransforms().translation(0.23f, vertical_offset, -0.23f).end().renderType("minecraft:cutout_mipped"))
                .end();
    }
    ...
    public BlockModelBuilder stageCompat(ResourceLocation texture, Integer stage, String flower, String modid) {
        ...
        return models().getBuilder(flower + "_seed_stage" + stage)
                ...
                .customLoader(CompositeModelBuilder::begin)
                .child("flower0", models().singleTexture(flower + "0_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", texture)
                        .rootTransforms().translation(0.23f, vertical_offset, 0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .child("flower1", models().singleTexture(flower + "1_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", texture)
                        .rootTransforms().translation(-0.23f, vertical_offset, 0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .child("flower2", models().singleTexture(flower + "2_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", texture)
                        .rootTransforms().translation(-0.23f, vertical_offset, -0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .child("flower3", models().singleTexture(flower + "3_stage" + stage, ResourceLocation.fromNamespaceAndPath(MODID, "block/cross_stage" + stage), "cross", texture)
                        .rootTransforms().translation(0.23f, vertical_offset, -0.23f).end()
                        .renderType("minecraft:cutout_mipped"))
                .end();
    }
